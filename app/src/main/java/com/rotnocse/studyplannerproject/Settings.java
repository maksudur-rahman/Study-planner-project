...
import com.rotnocse.studyplannerproject.Utils.AppCompatPreferenceActivity;
    ...
    public static class AboutFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            aboutPage.addGroup("Connect")
                    .addEmail("rotnocse@gmail.com")
                    .addWebsite("https://www.linkedin.com/in/rotnocse/")
                    .addFacebook("rotno.moon")
                    .addPlayStore("com.rotnocse.studyplannerproject")
                    .addGitHub("rotnocse");
